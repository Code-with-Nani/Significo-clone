...
const Capsules = () => {
  return (
    <div className="w-full min-h-screen p-5 lg:p-12 flex flex-col lg:flex-row lg:gap-20">
      ...
      <div className="lower mt-20 lg:mt-0 flex flex-col lg:flex-row gap-12">
        {capsule.map((items, index) => (
          <div
            key={index}
            className="capsule border-[1px] border-black rounded-full p-10 flex flex-col justify-between items-center lg:rotate-[-16deg]"
          >
